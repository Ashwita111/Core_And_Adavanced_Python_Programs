...
member1 = MoviesLibrary("Ashwita")
member1.borrow_movie("Inception")
member1.borrow_movie("The Matrix")
member1.view_borrowed_movies()
member1.return_movie("Inception")
member1.return_movie("Ramayana")
member1.view_borrowed_movies()

'''Output'''
"""Inception has been borrowed by Ashwita
The Matrix is not available in the library
Ashwita has borrowed: ['Inception']
Inception has been returned to the library by Ashwita
Ramayana was not borrowed by Ashwita
Ashwita has borrowed: []"""