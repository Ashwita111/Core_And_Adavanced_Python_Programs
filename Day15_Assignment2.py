#Assignment 2 - Write a function in Python to count and display the total number of words in a text file “ABC.txt”

#Creating function
def Word_count():
    count = 0           #counter variable
    try:                #handeling error suing try except
        with open("C:/Users/HP/Desktop/Ashwita python pro/ABC.txt" ,"r") as file_open:
...
'''Output'''
'''the numbers of words count is 7'''