...
member1 = LibraryMember("ashwita")
member2 = LibraryMember("anjali")
...
ashwita has borrowed Python Programming
Book not available.
Total Books: 3
Available Books: Data Structures, Machine Learning, AI Basics
ashwita has returned Python Programming
anjali has not borrowed Data Structures
Total Books: 4
